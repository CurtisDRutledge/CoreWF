...
public sealed class RuntimeArgument : LocationReference
{
    ...
    public RuntimeArgument(string name, Type argumentType, ArgumentDirection direction, bool isRequired, List<string> overloadGroups, PropertyDescriptor bindingProperty, object propertyOwner)
    ...
    public RuntimeArgument(string name, Type argumentType, ArgumentDirection direction, bool isRequired, List<string> overloadGroups, Argument argument)
        : this(name, argumentType, direction, isRequired, overloadGroups)
    {
    ...
    public static IComparer<RuntimeArgument> EvaluationOrderComparer
    {
        get
        {
    ...
    public bool IsBound => _boundArgument != null;

    public bool IsEvaluationOrderSpecified => IsBound && BoundArgument.EvaluationOrder != Argument.UnspecifiedEvaluationOrder;

    public Argument BoundArgument
    {
        get => _boundArgument;
    ...
    public void SetupBinding(Activity owningElement, bool createEmptyBinding)
    {
    ...
    public bool InitializeRelationship(Activity parent, ref IList<ValidationError> validationErrors)
    {
    ...
    public bool TryPopulateValue(LocationEnvironment targetEnvironment, ActivityInstance targetActivityInstance, ActivityExecutor executor, object argumentValueOverride, Location resultLocation, bool skipFastPath)
    {
    ...
    // it's marked public so that DataModel CIT can access it
    public static class CRCHashCode
    {
