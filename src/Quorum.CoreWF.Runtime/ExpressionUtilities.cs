...
public static class ExpressionUtilities
{
    ...
    public static bool TryGetInlinedReference(CodeActivityPublicEnvironmentAccessor publicAccessor, LocationReference originalReference,
    ...
    private class ArrayLocationFactory<T> : LocationFactory<T>
    {
        ...
        [DataContract]
        public class ArrayLocation : Location<T>
        {
            private T[] array;
            private int index;
    ...
    private class FieldLocationFactory<T> : LocationFactory<T>
    {
        ...
        [DataContract]
        public class FieldLocation : Location<T>
        {
            ...
            public FieldInfo SerializedFieldInfo
            {
            ...
            public Location SerializedParent
            {
    ...
    private class IndexerLocationFactory<T> : LocationFactory<T>
    {
        ...
        [DataContract]
        public class IndexerLocation : Location<T>
        {
            ...
            public string SerializedIndexerName
            {
            ...
            public MethodInfo SerializedGetItemMethod
            {
            ...
            public MethodInfo SerializedSetItemMethod
            {
            ...
            public object[] SerializedSetItemArguments
            {
    ...
    private class MultidimensionalArrayLocationFactory<T> : LocationFactory<T>
    {
        ...
        [DataContract]
        public class MultidimensionalArrayLocation : Location<T>
        {
            private Array array;
            private int[] indices;
    ...
    private class PropertyLocationFactory<T> : LocationFactory<T>
    {
        ...
        [DataContract]
        public class PropertyLocation : Location<T>
        {
            private object owner;
            ...
            public override T Value
            {
                get
                {
                    ...
                    // from the other's perspective, not public properties, so they're okay as a special case.
            ...
            public PropertyInfo SerializedPropertyInfo
            {
    ...
    public static Expression RewriteNonCompiledExpressionTree(LambdaExpression originalLambdaExpression)
    {
