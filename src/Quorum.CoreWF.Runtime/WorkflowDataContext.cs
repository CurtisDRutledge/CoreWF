...
public sealed class WorkflowDataContext : CustomTypeDescriptor, INotifyPropertyChanged, IDisposable
{
    ...
    public WorkflowDataContext(ActivityExecutor executor, ActivityInstance activityInstance, bool includeLocalVariables)
    {
        _executor = executor;
    ...
    public bool IncludesLocalVariables { get; set; }
    ...
    public void DisposeEnvironment() => _activityInstance = null;
