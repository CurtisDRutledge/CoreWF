...
public struct CodeActivityMetadata
{
    ...
    public CodeActivityMetadata(Activity activity, LocationReferenceEnvironment environment, bool createEmptyBindings)
    {
        _activity = activity;
    ...
    public bool CreateEmptyBindings => _createEmptyBindings;
    ...
    public void Dispose() => _activity = null;
}
