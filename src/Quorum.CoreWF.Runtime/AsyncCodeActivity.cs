...
public abstract class AsyncCodeActivity : Activity, IAsyncCodeActivity
{
    ...
    public static AsyncCallback OnExecuteComplete
    {
        get
        {
    ...
    public override bool InternalCanInduceIdle => true;
    ...
    public static void CompleteAsynchronousExecution(IAsyncResult result)
    {
        if (result.CompletedSynchronously)
        {
            return;
