...
public class AssemblyReference
{
    ...
    public AssemblyReference(Assembly assembly, AssemblyName assemblyName)
    {
        _assembly = assembly;
    ...
    public static bool AssemblySatisfiesReference(AssemblyName assemblyName, AssemblyName reference)
    {
