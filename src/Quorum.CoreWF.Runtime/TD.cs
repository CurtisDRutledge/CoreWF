...
public partial class TD
{
    ...
    public static void SetActivityId(Guid newId, out Guid oldId) => EventSource.SetCurrentThreadActivityId(newId, out oldId);

    /// <summary>
    /// Check if trace definition is enabled
    /// Event description ID=39456, Level=Warning, Channel=debug
    /// </summary>
    public static bool TrackingRecordDroppedIsEnabled()
    {
    ...
    public static void TrackingRecordDropped(long RecordNumber, Guid ProviderId)
    {
    ...
    /// </summary>
    public static bool TrackingRecordRaisedIsEnabled()
    {
    ...
    public static void TrackingRecordRaised(string param0, string param1)
    {
    ...
    /// </summary>
    public static bool TrackingRecordTruncatedIsEnabled()
    {
    ...
    public static void TrackingRecordTruncated(long RecordNumber, Guid ProviderId)
    {
    ...
    /// </summary>
    public static bool TrackingDataExtractedIsEnabled()
    {
    ...
    public static void TrackingDataExtracted(string Data, string Activity)
    {
    ...
    /// </summary>
    public static bool SwitchCaseNotFoundIsEnabled()
    {
    ...
    public static void SwitchCaseNotFound(string param0)
    {
    ...
    /// </summary>
    public static bool TryCatchExceptionFromTryIsEnabled()
    {
    ...
    public static void TryCatchExceptionFromTry(string param0, string param1)
    {
    ...
    /// </summary>
    public static bool TryCatchExceptionDuringCancelationIsEnabled()
    {
    ...
    public static void TryCatchExceptionDuringCancelation(string param0)
    {
    ...
    /// </summary>
    public static bool TryCatchExceptionFromCatchOrFinallyIsEnabled()
    {
    ...
    public static void TryCatchExceptionFromCatchOrFinally(string param0)
    {
    ...
    /// </summary>
    public static bool CompleteBookmarkWorkItemIsEnabled()
    {
    ...
    public static void CompleteBookmarkWorkItem(string param0, string param1, string param2, string param3, string param4)
    {
    ...
    /// </summary>
    public static bool CompleteCancelActivityWorkItemIsEnabled()
    {
    ...
    public static void CompleteCancelActivityWorkItem(string param0, string param1, string param2)
    {
    ...
    /// </summary>
    public static bool CompleteCompletionWorkItemIsEnabled()
    {
    ...
    public static void CompleteCompletionWorkItem(string param0, string param1, string param2, string param3, string param4, string param5)
    {
    ...
    /// </summary>
    public static bool CompleteExecuteActivityWorkItemIsEnabled()
    {
    ...
    public static void CompleteExecuteActivityWorkItem(string param0, string param1, string param2)
    {
    ...
    /// </summary>
    public static bool CompleteFaultWorkItemIsEnabled()
    {
    ...
    public static void CompleteFaultWorkItem(string param0, string param1, string param2, string param3, string param4, string param5, Exception exception)
    {
    ...
    /// </summary>
    public static bool CompleteRuntimeWorkItemIsEnabled()
    {
    ...
    public static void CompleteRuntimeWorkItem(string param0, string param1, string param2)
    {
    ...
    /// </summary>
    public static bool CompleteTransactionContextWorkItemIsEnabled()
    {
    ...
    public static void CompleteTransactionContextWorkItem(string param0, string param1, string param2)
    {
    ...
    /// </summary>
    public static bool CreateBookmarkIsEnabled()
    {
    ...
    public static void CreateBookmark(string param0, string param1, string param2, string param3, string param4)
    {
    ...
    /// </summary>
    public static bool CreateBookmarkScopeIsEnabled()
    {
    ...
    public static void CreateBookmarkScope(string param0)
    {
    ...
    /// </summary>
    public static bool EnterNoPersistBlockIsEnabled()
    {
    ...
    /// Event description ID=1038, Level=verbose, Channel=debug
    /// </summary>
    public static void EnterNoPersistBlock()
    {
    ...
    /// </summary>
    public static bool ExitNoPersistBlockIsEnabled()
    {
    ...
    /// Event description ID=1039, Level=verbose, Channel=debug
    /// </summary>
    public static void ExitNoPersistBlock()
    {
    ...
    /// </summary>
    public static bool InArgumentBoundIsEnabled()
    {
    ...
    public static void InArgumentBound(string param0, string param1, string param2, string param3, string param4)
    {
    ...
    /// </summary>
    public static bool RuntimeTransactionCompleteIsEnabled()
    {
    ...
    public static void RuntimeTransactionComplete(string param0)
    {
    ...
    /// </summary>
    public static bool RuntimeTransactionCompletionRequestedIsEnabled()
    {
    ...
    public static void RuntimeTransactionCompletionRequested(string param0, string param1, string param2)
    {
    ...
    /// </summary>
    public static bool RuntimeTransactionSetIsEnabled()
    {
    ...
    public static void RuntimeTransactionSet(string param0, string param1, string param2, string param3, string param4, string param5)
    {
    ...
    /// </summary>
    public static bool ScheduleBookmarkWorkItemIsEnabled()
    {
    ...
    public static void ScheduleBookmarkWorkItem(string param0, string param1, string param2, string param3, string param4)
    {
    ...
    /// </summary>
    public static bool ScheduleCancelActivityWorkItemIsEnabled()
    {
    ...
    public static void ScheduleCancelActivityWorkItem(string param0, string param1, string param2)
    {
    ...
    /// </summary>
    public static bool ScheduleCompletionWorkItemIsEnabled()
    {
    ...
    public static void ScheduleCompletionWorkItem(string param0, string param1, string param2, string param3, string param4, string param5)
    {
    ...
    /// </summary>
    public static bool ScheduleExecuteActivityWorkItemIsEnabled()
    {
    ...
    public static void ScheduleExecuteActivityWorkItem(string param0, string param1, string param2)
    {
    ...
    /// </summary>
    public static bool ScheduleFaultWorkItemIsEnabled()
    {
    ...
    /// <param name="exception">Exception associated with the event</param>
    public static void ScheduleFaultWorkItem(string param0, string param1, string param2, string param3, string param4, string param5, Exception exception)
    {
    ...
    /// </summary>
    public static bool ScheduleRuntimeWorkItemIsEnabled()
    {
    ...
    public static void ScheduleRuntimeWorkItem(string param0, string param1, string param2)
    {
    ...
    /// </summary>
    public static bool ScheduleTransactionContextWorkItemIsEnabled()
    {
    ...
    public static void ScheduleTransactionContextWorkItem(string param0, string param1, string param2)
    {
    ...
    /// </summary>
    public static bool StartBookmarkWorkItemIsEnabled()
    {
    ...
    public static void StartBookmarkWorkItem(string param0, string param1, string param2, string param3, string param4)
    {
    ...
    /// </summary>
    public static bool StartCancelActivityWorkItemIsEnabled()
    {
    ...
    public static void StartCancelActivityWorkItem(string param0, string param1, string param2)
    {
    ...
    /// </summary>
    public static bool StartCompletionWorkItemIsEnabled()
    {
    ...
    public static void StartCompletionWorkItem(string param0, string param1, string param2, string param3, string param4, string param5)
    {
    ...
    /// </summary>
    public static bool StartExecuteActivityWorkItemIsEnabled()
    {
    ...
    public static void StartExecuteActivityWorkItem(string param0, string param1, string param2)
    {
    ...
    /// </summary>
    public static bool StartFaultWorkItemIsEnabled()
    {
    ...
    /// <param name="exception">Exception associated with the event</param>
    public static void StartFaultWorkItem(string param0, string param1, string param2, string param3, string param4, string param5, Exception exception)
    {
    ...
    /// </summary>
    public static bool StartRuntimeWorkItemIsEnabled()
    {
    ...
    public static void StartRuntimeWorkItem(string param0, string param1, string param2)
    {
    ...
    /// </summary>
    public static bool StartTransactionContextWorkItemIsEnabled()
    {
    ...
    public static void StartTransactionContextWorkItem(string param0, string param1, string param2)
    {
    ...
    /// </summary>
    public static bool BookmarkScopeInitializedIsEnabled()
    {
    ...
    public static void BookmarkScopeInitialized(string param0, string param1)
    {
    ...
    /// </summary>
    public static bool WorkflowActivityResumeIsEnabled()
    {
    ...
    public static void WorkflowActivityResume(Guid Id)
    {
    ...
    /// </summary>
    public static bool WorkflowActivityStartIsEnabled()
    {
    ...
    /// </summary>
    /// <param name="Id">Parameter 0 for event: WorkflowInstance Id: '{0}' E2E Activity</param>
    public static void WorkflowActivityStart(Guid Id)
    {
    ...
    /// </summary>
    public static bool WorkflowActivityStopIsEnabled()
    {
    ...
    /// </summary>
    /// <param name="Id">Parameter 0 for event: WorkflowInstance Id: '{0}' E2E Activity</param>
    public static void WorkflowActivityStop(Guid Id)
    {
    ...
    /// </summary>
    public static bool WorkflowActivitySuspendIsEnabled()
    {
    ...
    /// </summary>
    /// <param name="Id">Parameter 0 for event: WorkflowInstance Id: '{0}' E2E Activity</param>
    public static void WorkflowActivitySuspend(Guid Id)
    {
    ...
    /// </summary>
    public static bool ActivityCompletedIsEnabled()
    {
    ...
    public static void ActivityCompleted(string param0, string param1, string param2, string param3)
    {
    ...
    /// </summary>
    public static bool ActivityScheduledIsEnabled()
    {
    ...
    public static void ActivityScheduled(string param0, string param1, string param2, string param3, string param4, string param5)
    {
    ...
    /// </summary>
    public static bool WorkflowInstanceAbortedIsEnabled()
    {
    ...
    /// <param name="exception">Exception associated with the event</param>
    public static void WorkflowInstanceAborted(string param0, Exception exception)
    {
    ...
    /// </summary>
    public static bool WorkflowInstanceCanceledIsEnabled()
    {
    ...
    public static void WorkflowInstanceCanceled(string param0)
    {
    ...
    /// </summary>
    public static bool WorkflowApplicationCompletedIsEnabled()
    {
    ...
    public static void WorkflowApplicationCompleted(string param0)
    {
    ...
    /// </summary>
    public static bool WorkflowApplicationIdledIsEnabled()
    {
    ...
    public static void WorkflowApplicationIdled(string param0)
    {
    ...
    /// </summary>
    public static bool WorkflowApplicationPersistableIdleIsEnabled()
    {
    ...
    public static void WorkflowApplicationPersistableIdle(string param0, string param1)
    {
    ...
    /// </summary>
    public static bool WorkflowApplicationPersistedIsEnabled()
    {
    ...
    public static void WorkflowApplicationPersisted(string param0)
    {
    ...
    /// </summary>
    public static bool WorkflowApplicationTerminatedIsEnabled()
    {
    ...
    /// <param name="exception">Exception associated with the event</param>
    public static void WorkflowApplicationTerminated(string param0, Exception exception)
    {
    ...
    /// </summary>
    public static bool WorkflowApplicationUnhandledExceptionIsEnabled()
    {
    ...
    /// <param name="exception">Exception associated with the event</param>
    public static void WorkflowApplicationUnhandledException(string param0, string param1, string param2, string param3, Exception exception)
    {
    ...
    /// </summary>
    public static bool WorkflowApplicationUnloadedIsEnabled()
    {
    ...
    public static void WorkflowApplicationUnloaded(string param0)
    {
    ...
    /// </summary>
    public static bool InvokeMethodIsStaticIsEnabled()
    {
    ...
    public static void InvokeMethodIsStatic(string param0)
    {
    ...
    /// </summary>
    public static bool InvokeMethodIsNotStaticIsEnabled()
    {
    ...
    public static void InvokeMethodIsNotStatic(string param0)
    {
    ...
    /// </summary>
    public static bool InvokedMethodThrewExceptionIsEnabled()
    {
    ...
    public static void InvokedMethodThrewException(string param0, string param1)
    {
    ...
    /// </summary>
    public static bool InvokeMethodUseAsyncPatternIsEnabled()
    {
    ...
    public static void InvokeMethodUseAsyncPattern(string param0, string param1, string param2)
    {
    ...
    /// </summary>
    public static bool InvokeMethodDoesNotUseAsyncPatternIsEnabled()
    {
    ...
    public static void InvokeMethodDoesNotUseAsyncPattern(string param0)
    {
    ...
    /// </summary>
    public static bool FlowchartStartIsEnabled()
    {
    ...
    public static void FlowchartStart(string param0)
    {
    ...
    /// </summary>
    public static bool FlowchartEmptyIsEnabled()
    {
    ...
    public static void FlowchartEmpty(string param0)
    {
    ...
    /// </summary>
    public static bool FlowchartNextNullIsEnabled()
    {
    ...
    public static void FlowchartNextNull(string param0)
    {
    ...
    /// </summary>
    public static bool FlowchartSwitchCaseIsEnabled()
    {
    ...
    public static void FlowchartSwitchCase(string param0, string param1)
    {
    ...
    /// </summary>
    public static bool FlowchartSwitchDefaultIsEnabled()
    {
    ...
    public static void FlowchartSwitchDefault(string param0)
    {
    ...
    /// </summary>
    public static bool FlowchartSwitchCaseNotFoundIsEnabled()
    {
    ...
    public static void FlowchartSwitchCaseNotFound(string param0)
    {
    ...
    /// </summary>
    public static bool CompensationStateIsEnabled()
    {
    ...
    public static void CompensationState(string param0, string param1)
    {
    ...
    /// </summary>
    public static bool TrackingValueNotSerializableIsEnabled()
    {
    ...
    public static void TrackingValueNotSerializable(string name)
    {
    ...
    /// </summary>
    public static bool ExecuteWorkItemStartIsEnabled()
    {
    ...
    /// Event description ID=2021, Level=Verbose, Channel=debug
    /// </summary>
    public static void ExecuteWorkItemStart()
    {
    ...
    /// </summary>
    public static bool ExecuteWorkItemStopIsEnabled()
    {
    ...
    /// Event description ID=2022, Level=Verbose, Channel=debug
    /// </summary>
    public static void ExecuteWorkItemStop()
    {
    ...
    /// </summary>
    public static bool InternalCacheMetadataStartIsEnabled()
    {
    ...
    public static void InternalCacheMetadataStart(string id)
    {
    ...
    /// </summary>
    public static bool InternalCacheMetadataStopIsEnabled()
    {
    ...
    public static void InternalCacheMetadataStop(string id)
    {
    ...
    /// </summary>
    public static bool CompileVbExpressionStartIsEnabled()
    {
    ...
    public static void CompileVbExpressionStart(string expr)
    {
    ...
    /// </summary>
    public static bool CompileVbExpressionStopIsEnabled()
    {
    ...
    /// Event description ID=2029, Level=Verbose, Channel=debug
    /// </summary>
    public static void CompileVbExpressionStop()
    {
    ...
    /// </summary>
    public static bool CacheRootMetadataStartIsEnabled()
    {
    ...
    public static void CacheRootMetadataStart(string activityName)
    {
    ...
    /// </summary>
    public static bool CacheRootMetadataStopIsEnabled()
    {
    ...
    public static void CacheRootMetadataStop(string activityName)
    {
        WfEventSource.Instance.CacheRootMetadataStop(activityName);
    }

    public static void TraceTransfer(Guid newId)
    {
    ...
    public static bool ShouldTraceToTraceSource(EventLevel level)
    {
        return WfEventSource.Instance.IsEnabled(level, EventKeywords.All);
    }

    public static bool IsEnd2EndActivityTracingEnabled()
    {
        return false;
    }
}
