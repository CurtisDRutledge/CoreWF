...
/// <summary>
/// InternalTransition is representation of transition.
/// Its difference from transition is that if several transition share the same trigger, all of them belongs to the same transition.
...
sealed class InternalTransition
{
    ...
    /// <summary>
    /// Gets or sets trigger object of this transition.
    /// </summary>
