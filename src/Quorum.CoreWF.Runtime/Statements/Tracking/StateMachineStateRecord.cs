...
{
    public static readonly string StateMachineStateRecordName = "System.Activities.Statements.StateMachine";
    ...
    StateMachineStateRecord(string name)
        : base(name) { }

    StateMachineStateRecord(string name, EventLevel level)
        : base(name, level) { }

    StateMachineStateRecord(Guid instanceId, string name, EventLevel level)
    ...
    public string StateMachineName
    {
        ...
        set => Data[StateMachineKey] = value;
    }
    ...
    public override TrackingRecord Clone() => new StateMachineStateRecord(this);
}
