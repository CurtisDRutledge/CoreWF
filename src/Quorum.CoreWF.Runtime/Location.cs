...
public abstract class Location
{
    ...
    public TemporaryResolutionData SerializedTemporaryResolutionData
    {
        get => temporaryResolutionData;
        set => temporaryResolutionData = value;
    }

    public virtual bool CanBeMapped => false;
    ...
    public LocationEnvironment TemporaryResolutionEnvironment => temporaryResolutionData.TemporaryResolutionEnvironment;

    public bool BufferGetsOnCollapse => temporaryResolutionData.BufferGetsOnCollapse;

    protected abstract object ValueCore { get; set; }

    public void SetTemporaryResolutionData(LocationEnvironment resolutionEnvironment, bool bufferGetsOnCollapse)
    {
    ...
    public virtual Location CreateReference(bool bufferGets)
    {
    ...
    [DataContract]
    public struct TemporaryResolutionData
    {
    ...
    [DataContract]
    public class ReferenceLocation : Location
    {
        ...
        public Location SerializedInnerLocation
        {
            get => _innerLocation;
        ...
        public bool SerializedBufferGets
        {
            get => _bufferGets;
        ...
        public object SerializedBufferedValue
        {
            get => _bufferedValue;
...
public class Location<T> : Location
{
    ...
    public override Location CreateReference(bool bufferGets)
    {
        if (CanBeMapped || bufferGets)
        {
            return new ReferenceLocation(this, bufferGets);
    ...
    public override object CreateDefaultValue()
    {
    ...
    [DataContract]
    public new class ReferenceLocation : Location<T>
    {
        ...
        [DataMember(Name = "innerLocation")]
        public Location<T> SerializedInnerLocation
        {
            get => _innerLocation;
            set => _innerLocation = value;
        }
