...
public abstract partial class Activity
{
    ...
    public static readonly ReadOnlyCollection<Constraint> _emptyConstraints = new(Array.Empty<Constraint>());
    ...
    [DefaultValue(null)]
    [IgnoreDataMember]
    public virtual Version ImplementationVersion { get; set; }
    ...
    public RelationshipType RelationshipToParent => _relationshipToParent;

    public bool HasNonEmptySubtree
    {
        get
        {
    ...
    public IdSpace MemberOf { get; set; }

    public IdSpace ParentOf { get; set; }
    ...
    public bool UseOldFastPath { get; set; }

    public bool SkipArgumentResolution { get; set; }

    public bool IsFastPath => SkipArgumentResolution && IsActivityWithResult;

    public virtual bool IsActivityWithResult => false;
    ...
    public bool IsExpressionRoot => _relationshipToParent == RelationshipType.ArgumentExpression;

    public bool HasStartedCachingMetadata => _isMetadataCached != CacheStates.Uncached;

    public bool IsMetadataCached => _isMetadataCached != CacheStates.Uncached;

    public bool IsMetadataFullyCached => (_isMetadataCached & CacheStates.Full) == CacheStates.Full;

    public bool IsRuntimeReady => (_isMetadataCached & CacheStates.RuntimeReady) == CacheStates.RuntimeReady;

    public Activity RootActivity => _rootActivity;
    ...
    public ActivityDelegate HandlerOf { get; private set; }

    public Activity Parent { get; private set; }

    public LocationReferenceEnvironment HostEnvironment => RootActivity?._rootProperties?.HostEnvironment;

    public IList<RuntimeArgument> RuntimeArguments => _arguments;

    public IList<Activity> Children => _children;

    public IList<Activity> ImplementationChildren => _implementationChildren;

    public IList<Activity> ImportedChildren => _importedChildren;

    public IList<ActivityDelegate> Delegates => _delegates;

    public IList<ActivityDelegate> ImplementationDelegates => _implementationDelegates;

    public IList<ActivityDelegate> ImportedDelegates => _importedDelegates;
    ...
    public IList<Variable> RuntimeVariables => _variables;

    public IList<Variable> ImplementationVariables => _implementationVariables;

    public IList<Constraint> RuntimeConstraints => InternalGetConstraints();

    public LocationReferenceEnvironment PublicEnvironment { get; set; }

    public LocationReferenceEnvironment ImplementationEnvironment { get; set; }

    public virtual bool InternalCanInduceIdle => false;

    public bool HasTempViolations => _tempValidationErrors != null && _tempValidationErrors.Count > 0;
    ...
    public virtual bool IsResultArgument(RuntimeArgument argument) => false;

    public virtual bool CanBeScheduledBy(Activity parent)
    {
    ...
    public void SetChildrenCollection(Collection<Activity> children) => _children = children;
    ...
    public void SetImplementationChildrenCollection(Collection<Activity> implementationChildren) => _implementationChildren = implementationChildren;
    ...
    public void SetImportedChildrenCollection(Collection<Activity> importedChildren) => _importedChildren = importedChildren;
    ...
    public void SetDelegatesCollection(Collection<ActivityDelegate> delegates) => _delegates = delegates;
    ...
    public void SetImplementationDelegatesCollection(Collection<ActivityDelegate> implementationDelegates) => _implementationDelegates = implementationDelegates;
    ...
    public void SetImportedDelegatesCollection(Collection<ActivityDelegate> importedDelegates) => _importedDelegates = importedDelegates;
    ...
    public void SetVariablesCollection(Collection<Variable> variables) => _variables = variables;
    ...
    public void SetImplementationVariablesCollection(Collection<Variable> implementationVariables) => _implementationVariables = implementationVariables;
    ...
    public void SetArgumentsCollection(Collection<RuntimeArgument> arguments, bool createEmptyBindings)
    {
    ...
    public void AddArgument(RuntimeArgument argument, bool createEmptyBindings)
    {
    ...
    public void SetTempValidationErrorCollection(IList<ValidationError> validationErrors) => _tempValidationErrors = validationErrors;

    public void TransferTempValidationErrors(ref IList<ValidationError> newList)
    {
    ...
    public void AddTempValidationError(ValidationError validationError)
    {
        _tempValidationErrors ??= new Collection<ValidationError>();
        _tempValidationErrors.Add(validationError);
    }

    public RuntimeArgument AddTempAutoGeneratedArgument(Type argumentType, ArgumentDirection direction)
    {
    ...
    public void ResetTempAutoGeneratedArguments() => _tempAutoGeneratedArguments = null;

    public virtual IList<Constraint> InternalGetConstraints() => _constraints != null && _constraints.Count > 0 ? _constraints : Activity._emptyConstraints;
    ...
    public virtual void InternalAbort(ActivityInstance instance, ActivityExecutor executor, Exception terminationReason) { }

    // subclasses are responsible for creating/disposing the necessary contexts
    public virtual void InternalExecute(ActivityInstance instance, ActivityExecutor executor, BookmarkManager bookmarkManager)
    {
    ...
    public virtual void InternalCancel(ActivityInstance instance, ActivityExecutor executor, BookmarkManager bookmarkManager)
    {
    ...
    public void InitializeAsRoot(LocationReferenceEnvironment hostEnvironment)
    {
    ...
    public LocationReferenceEnvironment GetParentEnvironment()
    {
    ...
    public bool InitializeRelationship(ActivityDelegate activityDelegate, ActivityCollectionType collectionType, ref IList<ValidationError> validationErrors)
    {
    ...
    public bool InitializeRelationship(RuntimeArgument argument, ref IList<ValidationError> validationErrors)
        => InitializeRelationship(argument.Owner, true, RelationshipType.ArgumentExpression, ref validationErrors);

    public bool InitializeRelationship(Variable variable, bool isPublic, ref IList<ValidationError> validationErrors)
    ...
    public void InternalCacheMetadata(bool createEmptyBindings, ref IList<ValidationError> validationErrors)
    {
    ...
    public void SetCached(bool isSkippingPrivateChildren) => _isMetadataCached = isSkippingPrivateChildren ? CacheStates.Partial : CacheStates.Full;

    public void SetRuntimeReady() => _isMetadataCached |= CacheStates.RuntimeReady;

    public virtual void OnInternalCacheMetadata(bool createEmptyBindings)
    {
...
#if DYNAMICUPDATE
    public virtual void OnInternalCreateDynamicUpdateMap(DynamicUpdateMapBuilder.Finalizer finalizer,
...
public abstract class Activity<TResult> : ActivityWithResult
{
    ...
    public override Type InternalResultType => typeof(TResult);

    public override OutArgument ResultCore
    {
        get => Result;
        set
        {
    ...
    public override bool IsResultArgument(RuntimeArgument argument) => ReferenceEquals(argument, ResultRuntimeArgument);

    public sealed override void OnInternalCacheMetadata(bool createEmptyBindings)
    {
    ...
    public virtual void OnInternalCacheMetadataExceptResult(bool createEmptyBindings)
        => base.OnInternalCacheMetadata(createEmptyBindings);

    public override object InternalExecuteInResolutionContextUntyped(CodeActivityContext resolutionContext)
        => InternalExecuteInResolutionContext(resolutionContext);

    public virtual TResult InternalExecuteInResolutionContext(CodeActivityContext resolutionContext)
