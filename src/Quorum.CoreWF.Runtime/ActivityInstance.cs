...
#endif
{
    ...
    public Substate SubState => _substate;

    [DataMember(EmitDefaultValue = false)]
    public LocationEnvironment SerializedEnvironment
    {
        get
        {
            if (IsCompleted)
    ...
    public int SerializedBusyCount
    {
        get => _busyCount;
    ...
    public ExtendedData SerializedExtendedData
    {
        get => _extendedData;
    ...
    public bool SerializedNoSymbols
    {
        get => _noSymbols;
    ...
    public ActivityInstanceState SerializedState
    {
        get => _state;
        set => _state = value;
    }
    ...
    public bool SerializedIsCancellationRequested
    {
    ...
    public bool SerializedPerformingDefaultCancelation
    {
    ...
    public Substate SerializedSubstate
    {
        get => _substate;
        set => _substate = value;
    }
    ...
    public bool SerializedInitializationIncomplete
    {
        get => _initializationIncomplete;
        set => _initializationIncomplete = value;
    }

    public LocationEnvironment Environment
    {
        get
        {
    ...
    public ActivityInstanceMap InstanceMap => _instanceMap;
    ...
    public bool IsPerformingDefaultCancelation => _performingDefaultCancelation;

    public string Id => _id.ToString(CultureInfo.InvariantCulture);

    public long publicId => _id;

    public bool IsEnvironmentOwner => !_noSymbols;

    public bool IsResolvingArguments => _substate == Substate.ResolvingArguments;

    public bool HasNotExecuted => (_substate & Substate.PreExecuting) != 0;
    ...
    public bool OnlyHasOutstandingBookmarks
    {
        get
        {
    ...
    public ActivityInstance Parent => _parent;
    ...
    [DataMember(EmitDefaultValue = false)]
    public CompletionBookmark CompletionBookmark
    {
    ...
    public bool HasChildren => (_childList != null && _childList.Count > 0);

    public ExecutionPropertyManager PropertyManager
    {
    ...
    public object CompiledDataContexts { get; set; }

    public object CompiledDataContextsForImplementation { get; set; }

    public bool HasActivityReferences => _extendedData != null && _extendedData.HasActivityReferences;
    ...
    public ChildList SerializedChildren
    {
        get
        {
            if (HasChildren)
    ...
    public static ActivityInstance CreateCompletedInstance(Activity activity)
    {
    ...
    public static ActivityInstance CreateCanceledInstance(Activity activity)
    {
        ActivityInstance instance = new(activity)
        {
    ...
    public HybridCollection<ActivityInstance> GetRawChildren() => _childList;
    ...
    public void IncrementBusyCount() => _busyCount++;
    ...
    public void DecrementBusyCount(int amount)
    {
    ...
    public void AddBookmark(Bookmark bookmark, BookmarkOptions options)
    {
    ...
    public void RemoveBookmark(Bookmark bookmark, BookmarkOptions options)
    {
        bool affectsBusyCount = false;
    ...
    public void RemoveAllBookmarks(BookmarkScopeManager bookmarkScopeManager, BookmarkManager bookmarkManager)
        => _extendedData?.PurgeBookmarks(bookmarkScopeManager, bookmarkManager, this);

    public void SetInitializationIncomplete() => _initializationIncomplete = true;
    ...
    public void MarkAsComplete(BookmarkScopeManager bookmarkScopeManager, BookmarkManager bookmarkManager)
    {
        if (_extendedData != null)
        {
            _extendedData.PurgeBookmarks(bookmarkScopeManager, bookmarkManager, this);
    ...
    public void Abort(ActivityExecutor executor, BookmarkManager bookmarkManager, Exception terminationReason, bool isTerminate)
    {
    ...
    public void BaseCancel(NativeActivityContext context)
    {
    ...
    public void CancelChildren(NativeActivityContext context)
    {
        if (HasChildren)
        {
    ...
    public void AddChild(ActivityInstance item)
    {
    ...
    public void RemoveChild(ActivityInstance item)
    {
    ...
    public void FixupInstance(ActivityInstance parent, ActivityInstanceMap instanceMap, ActivityExecutor executor)
    {
        if (IsCompleted)
        {
    ...
    public bool TryFixupChildren(ActivityInstanceMap instanceMap, ActivityExecutor executor)
    {
        if (!HasChildren)
        {
            return false;
    ...
    public bool Initialize(ActivityInstance parent, ActivityInstanceMap instanceMap, LocationEnvironment parentEnvironment, long instanceId, ActivityExecutor executor, int delegateParameterCount = 0)
    {
        _parent = parent;
        _instanceMap = instanceMap;
        _id = instanceId;
    ...
    public void ResolveNewArgumentsDuringDynamicUpdate(ActivityExecutor executor, IList<int> dynamicUpdateArgumentIndexes)
    {
    ...
    public bool ResolveArguments(ActivityExecutor executor, IDictionary<string, object> argumentValueOverrides, Location resultLocation, int startIndex = 0)
    {
        Fx.Assert(!_noSymbols, "Can only resolve arguments if we created an environment");
    ...
    public void ResolveNewVariableDefaultsDuringDynamicUpdate(ActivityExecutor executor, IList<int> dynamicUpdateVariableIndexes, bool forImplementation)
    {
    ...
    public bool ResolveVariables(ActivityExecutor executor)
    {
    ...
    public bool UpdateState(ActivityExecutor executor)
    {
    ...
    public void SetInitializedSubstate(ActivityExecutor executor)
    {
    ...
    public void FinalizeState(ActivityExecutor executor, bool faultActivity, bool skipTracking = false)
    {
        if (faultActivity)
        {
            TryCancelParent();
    ...
    public class ExtendedData
    {
        ...
        public int SerializedBlockingBookmarkCount
        {
        ...
        //[SuppressMessage(FxCop.Category.Performance, FxCop.Rule.AvoidUncalledPrivateCode, Justification = "Called from Serialization")]
        public ActivityReferenceList ActivityReferences
        {
            get
            {
        ...
        [DataContract]
        public class ActivityReferenceList : HybridCollection<ActivityInstanceReference>
        {
    ...
    [DataContract]
    public class ChildList : HybridCollection<ActivityInstance>
    {
