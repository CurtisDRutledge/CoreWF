...
public class ActivityContext
{
    ...
    public ActivityContext(ActivityInstance instance, ActivityExecutor executor)
    {
        ...
        _instanceId = instance.Activity.InternalId;
    }
    ...
    public bool AllowChainedEnvironmentAccess { get; set; }

    public Activity Activity { get; private set; }

    public ActivityInstance CurrentInstance => _instance;

    public ActivityExecutor CurrentExecutor => _executor;
    ...
    public void Reinitialize(ActivityInstance instance, ActivityExecutor executor)
        => Reinitialize(instance, executor, instance.Activity, instance.Activity.InternalId);

    public void Reinitialize(ActivityInstance instance, ActivityExecutor executor, Activity activity, long instanceId)
    {
        _isDisposed = false;
        _instance = instance;
        _executor = executor;
    ...
    public Location<T> GetInheritedLocation<T>(string locationName)
    {
    ...
    public Location<T> GetLocation<T>(string locationName)
    {
    ...
    public T GetValueCore<T>(LocationReference locationReference)
    {
    ...
    public void SetValueCore<T>(LocationReference locationReference, T value)
    {
    ...
    public void TrackCore(CustomTrackingRecord record)
    {
