...
public class BookmarkManager
{
    ...
    public BookmarkManager(BookmarkScope scope, BookmarkScopeHandle scopeHandle)
        : this()
    {
        _scope = scope;
    ...
    public Dictionary<Bookmark, BookmarkCallbackWrapper> SerializedBookmarks
    {
        get => _bookmarks;
    ...
    public BookmarkScope SerializedScope
    {
        get => _scope;
        set => _scope = value;
    }
    ...
    public BookmarkScopeHandle SerializedScopeHandle
    {
        get => _scopeHandle;
    ...
    // to our public Bookmark object.  This is necessary because we use bookmark objects as the key to our dictionary
    ...
    // public instances since this call comes from bookmarks hanging off of the
    ...
    public void PurgeSingleBookmark(Bookmark bookmark)
    {
    ...
    private static void UpdateExclusiveHandleList(Bookmark bookmark)
    {
        if (bookmark.ExclusiveHandles != null)
        {
            for (int i = 0; i < bookmark.ExclusiveHandles.Count; i++)
            {
                ...
                Fx.Assert(handle != null, "public error.. ExclusiveHandle was null");
