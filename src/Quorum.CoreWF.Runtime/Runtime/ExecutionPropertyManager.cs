...
public class ExecutionPropertyManager
{
    ...
    {
        Fx.Assert(owningInstance != null, "null instance should be using the public host-based ctor");
    ...
    public Dictionary<string, ExecutionProperty> Properties => _properties;

    public bool HasExclusiveHandlesInScope => _exclusiveHandleCount > 0;
    ...
    public bool ShouldSerialize(ActivityInstance instance) => IsOwner(instance) && _properties.Count > 0;
    ...
    public class ExecutionProperty
    {
        ...
        public bool SerializedHasRestrictedVisibility
        {
