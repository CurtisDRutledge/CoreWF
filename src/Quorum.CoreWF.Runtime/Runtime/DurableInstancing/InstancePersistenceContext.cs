...
public sealed class InstancePersistenceContext
{
    ...
    public InstancePersistenceContext(InstanceHandle handle, TimeSpan timeout)
        : this(handle)
    {
        _timeout = timeout;
    }
    ...
    public bool IsHandleDoomedByRollback { get; set; }
    ...
    [Fx.Tag.Blocking(CancelMethod = "NotifyHandleFree")]
    public static InstanceView OuterExecute(InstanceHandle initialInstanceHandle, InstancePersistenceCommand command, TimeSpan timeout)
    {
        try
        {
    ...
    public static IAsyncResult BeginOuterExecute(InstanceHandle initialInstanceHandle, InstancePersistenceCommand command, TimeSpan timeout, AsyncCallback callback, object state)
    {
        try
        {
    ...
    [Fx.Tag.Blocking(CancelMethod = "NotifyHandleFree", Conditional = "!result.IsCompleted")]
    public static InstanceView EndOuterExecute(IAsyncResult result)
    {
    ...
    private class ExecuteAsyncResult : AsyncResult
    {
        ...
        public InstancePersistenceCommand CurrentCommand { get; set; }

        public Action<InstancePersistenceContext> CancellationHandler
        {
            get
            {
    ...
    [Serializable]
    public class BindReclaimedLockException : Exception
    {
        public BindReclaimedLockException()
        {
        }

        public BindReclaimedLockException(AsyncWaitHandle markerWaitHandle)
