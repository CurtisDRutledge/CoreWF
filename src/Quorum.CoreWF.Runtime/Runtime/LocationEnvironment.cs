...
#endif
{
    ...
    public Location[] SerializedLocations
    {
        get => _locations;
    ...
    public bool SerializedHasMappableLocations
    {
    ...
    public LocationEnvironment SerializedParent
    {
        get => _parent;
        set => _parent = value;
    }
    ...
    public Location SerializedSingleLocation
    {
        get => _singleLocation;
    ...
    public int SerializedReferenceCountMinusOne
    {
    ...
    public bool SerializedHasOwnerCompleted
    {
        get => _hasOwnerCompleted;
        set => _hasOwnerCompleted = value;
    }

    public Activity Definition { get; private set; }

    public LocationEnvironment Parent
    {
        get => _parent;
        set => _parent = value;
    }

    public bool HasHandles => _hasHandles;

    private MappableObjectManager MappableObjectManager => _executor.MappableObjectManager;

    public bool ShouldDispose => _referenceCountMinusOne == -1;

    public bool HasOwnerCompleted => _hasOwnerCompleted;
    ...
    public void AddReference() => _referenceCountMinusOne++;

    public void RemoveReference(bool isOwner)
    {
        if (isOwner)
        {
    ...
    public void OnDeserialized(ActivityExecutor executor, ActivityInstance handleScope)
    {
        _executor = executor;
    ...
    public void ReinitializeHandles(ActivityInstance handleScope)
    {
    ...
    public void UninitializeHandles(ActivityInstance scope)
    {
        if (_hasHandles)
        {
    ...
    public void DeclareHandle(LocationReference locationReference, Location location, ActivityInstance activityInstance)
    {
        _hasHandles = true;
    ...
    public void DeclareTemporaryLocation<T>(LocationReference locationReference, ActivityInstance activityInstance, bool bufferGetsOnCollapse)
        where T : Location
    {
    ...
    public object GetValue(RuntimeArgument argument)
    {
    ...
    public Location<T> GetSpecificLocation<T>(int id) => GetSpecificLocation(id) as Location<T>;
    ...
    public void CollapseTemporaryResolutionLocations()
    {
        if (_locations == null)
        {
            if (_singleLocation != null &&
    ...
    public void CollapseTemporaryResolutionLocation(Location location)
    {
    ...
    public bool TryGetLocation(int id, out Location value)
    {
        ThrowIfDisposed();
    ...
    public bool TryGetLocation(int id, Activity environmentOwner, out Location value)
    {
        ThrowIfDisposed();
...
#if DYNAMICUPDATE
    public void Update(EnvironmentUpdateMap map, Activity activity)
    {
