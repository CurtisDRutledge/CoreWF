...
public partial class ActivityExecutor : IEnlistmentNotification
{
    ...
    public Guid WorkflowInstanceId
    {
        ...
        // public visibility for partial trust serialization purposes only.
        set
        {
            _instanceId = value;
    ...
    public BookmarkScopeManager BookmarkScopeManager
    {
        get
        {
    ...
    public BookmarkScopeManager RawBookmarkScopeManager => _bookmarkScopeManager;

    public BookmarkManager RawBookmarkManager => _bookmarkManager;

    public MappableObjectManager MappableObjectManager
    {
        get
        {
    ...
    public BookmarkManager SerializedBookmarkManager
    {
    ...
    public BookmarkScopeManager SerializedBookmarkScopeManager
    {
    ...
    public bool SerializedHasTrackedStarted
    {
    ...
    public long SerializedNextTrackingRecordNumber
    {
    ...
    public ActivityInstance SerializedRootInstance
    {
        get => _rootInstance;
    ...
    public Scheduler SerializedScheduler
    {
        get => _scheduler;
    ...
    public bool SerializedShouldRaiseMainBodyComplete
    {
    ...
    public long SerializedLastInstanceId
    {
        get => _lastInstanceId;
    ...
    public LocationEnvironment SerializedRootEnvironment
    {
    ...
    public IDictionary<string, object> SerializedWorkflowOutputs
    {
    ...
    public Bookmark SerializedMainRootCompleteBookmark
    {
    ...
    public ActivityInstanceState SerializedExecutionState
    {
        get => _executionState;
    ...
    public List<Handle> SerializedHandles
    {
        get => _handles;
        set => _handles = value;
    }
    ...
    public Exception SerializedCompletionException
    {
    ...
    public TransactionContextWaiter[] SerializedTransactionContextWaiters
    {
    ...
    //[SuppressMessage(FxCop.Category.Performance, FxCop.Rule.AvoidUncalledPrivateCode, Justification = "Used by serialization")]
    public Queue<PersistenceWaiter> SerializedPersistenceWaiters
    {
    ...
    //[SuppressMessage(FxCop.Category.Performance, FxCop.Rule.AvoidUncalledPrivateCode, Justification = "Used by serialization")]
    public List<ActivityInstance> SerializedExecutingSecondaryRootInstances
    {
    ...
    //[SuppressMessage(FxCop.Category.Performance, FxCop.Rule.AvoidUncalledPrivateCode, Justification = "Used by serialization")]
    public MappableObjectManager SerializedMappableObjectManager
    {
    ...
    public ActivityInstanceMap SerializedProgramMapping
    {
        get
        {
    ...
    // may be null
    public ExecutionPropertyManager RootPropertyManager => _rootPropertyManager;

    [DataMember(Name = XD.ActivityInstance.PropertyManager, EmitDefaultValue = false)]
    //[SuppressMessage(FxCop.Category.Performance, FxCop.Rule.AvoidUncalledPrivateCode, Justification = "Called from Serialization")]
    public ExecutionPropertyManager SerializedPropertyManager
    {
    ...
    public List<Handle> Handles => _handles;
    ...
    public T ExecuteInResolutionContext<T>(ActivityInstance parentInstance, Activity<T> expressionActivity)
    {
        ...
        _cachedResolutionContext ??= new CodeActivityContext(parentInstance, this);
        _cachedResolutionContext.Reinitialize(parentInstance, this, expressionActivity, parentInstance.Activity.InternalId);
        T result;
        try
        {
    ...
    public void ExecuteSynchronousWorkItem(WorkItem workItem)
    {
    ...
    public void ExitNoPersistForExceptionPropagation()
    {
    ...
    public Location GetIgnorableResultLocation(RuntimeArgument resultArgument)
    {
...
#pragma warning disable CA1822 // Mark members as static
    public void OnSchedulerThreadAcquired()
#pragma warning restore CA1822 // Mark members as static
    ...
    public ActivityInstanceReference CreateActivityInstanceReference(ActivityInstance toReference, ActivityInstance referenceOwner)
    {
    ...
    public void RethrowException(ActivityInstance fromInstance, FaultContext context)
        => _scheduler.PushWork(new RethrowExceptionWorkItem(fromInstance, context.Exception, context.Source));

    public void OnDeserialized(Activity workflow, WorkflowInstance workflowInstance)
    {
    ...
    public Scheduler.RequestedAction TryExecuteNonEmptyWorkItem(WorkItem workItem)
    {
    ...
    public Scheduler.RequestedAction OnExecuteWorkItem(WorkItem workItem)
    {
        workItem.Release(this);
    ...
    public IAsyncResult BeginAssociateKeys(ICollection<InstanceKey> keysToAssociate, AsyncCallback callback, object state)
        => new AssociateKeysAsyncResult(this, keysToAssociate, callback, state);

    public static void EndAssociateKeys(IAsyncResult result) => AssociateKeysAsyncResult.End(result);

    public void DisassociateKeys(ICollection<InstanceKey> keysToDisassociate) => _host.OnDisassociateKeys(keysToDisassociate);
    ...
    public void FinishWorkItemAfterTracking(WorkItem workItem)
    {
        Scheduler.RequestedAction resumptionAction = Scheduler.Continue;
    ...
    public Exception CompleteActivityInstance(ActivityInstance targetInstance)
    {
    ...
    public bool TryGetPendingOperation(ActivityInstance instance, out AsyncOperationContext asyncContext)
    {
    ...
    public void CancelPendingOperation(ActivityInstance instance)
    {
    ...
    public void HandleRootCompletion(ActivityInstance completedInstance)
    {
    ...
    public BookmarkResumptionResult TryResumeHostBookmark(Bookmark bookmark, object value)
    {
        bool hasTracedResume = TryTraceResume(out Guid oldActivityId);
    ...
    public BookmarkResumptionResult TryResumeUserBookmark(Bookmark bookmark, object value, bool isExternal)
    {
        if (_isDisposed)
        {
    ...
    public ReadOnlyCollection<BookmarkInfo> GetAllBookmarks()
    {
    ...
    public BookmarkResumptionResult TryResumeBookmark(Bookmark bookmark, object value, BookmarkScope scope)
    {
    ...
    public void ScheduleItem(WorkItem workItem) => _scheduler.PushWork(workItem);
    ...
    public void ScheduleExpression(ActivityWithResult activity, ActivityInstance parent, LocationEnvironment parentEnvironment, Location resultLocation, ResolveNextArgumentWorkItem nextArgumentWorkItem)
    {
    ...
    public void ScheduleExpressionFaultPropagation(Activity activity, long instanceId, ActivityInstance parent, Exception exception)
    {
    ...
    public void AddHandle(Handle handleToAdd)
    {
    ...
    [DataContract]
    public class PersistenceWaiter
    {
        ...
        public Bookmark SerializedOnPersistBookmark
        {
        ...
        public ActivityInstance SerializedWaitingInstance
        {
            get => WaitingInstance;
        ...
        [DataContract]
        public class PersistWorkItem : WorkItem
        {
            ...
            public PersistenceWaiter SerializedWaiter
            {
                get => _waiter;
                set => _waiter = value;
            }
    ...
    [DataContract]
    public class TransactionContextWaiter
    {
        ...
        public bool SerializedIsRequires
        {
            get => IsRequires;
        ...
        public RuntimeTransactionHandle SerializedHandle
        {
            get => Handle;
            set => Handle = value;
        }
        ...
        public TransactionContextWaiterCallbackWrapper SerializedCallbackWrapper
        {
            get => CallbackWrapper;
    ...
    [DataContract]
    public class TransactionContextWaiterCallbackWrapper : CallbackWrapper
    {
