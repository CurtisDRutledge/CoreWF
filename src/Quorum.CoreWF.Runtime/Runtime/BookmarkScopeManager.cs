...
[DataContract]
public class BookmarkScopeManager
{
    ...
    public BookmarkScope SerializedDefaultScope
    {
        get => _defaultScope;
    ...
    public long SerializedNextTemporaryId
    {
    ...
    public Dictionary<BookmarkScope, BookmarkManager> SerializedBookmarkManagers
    {
        get
        {
    ...
    [DataMember(EmitDefaultValue = false)]
    //[SuppressMessage(FxCop.Category.Performance, FxCop.Rule.AvoidUncalledPrivateCode, Justification = "Called from Serialization")]
    public List<BookmarkScope> SerializedUninitializedScopes
    {
        get
        {
    ...
    public BookmarkScope CreateAndRegisterScope(Guid scopeId, BookmarkScopeHandle scopeHandle)
    {
