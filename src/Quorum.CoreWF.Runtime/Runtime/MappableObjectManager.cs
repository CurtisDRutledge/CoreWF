...
[DataContract]
public class MappableObjectManager
{
    ...
    public List<MappableLocation> SerializedMappableLocations
    {
    ...
    public class MappableLocation
    {
        ...
        public string SerializedMappingKeyName
        {
            get => MappingKeyName;
        ...
        public string SerializedOwnerDisplayName
        {
        ...
        public Location SerializedLocation
        {
            get => Location;
            set => Location = value;
        }
