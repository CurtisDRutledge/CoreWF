...
public class ActivityInstanceMap
{
    ...
    public InstanceList[] SerializedInstanceLists
    {
        get
        {
    ...
    [DataContract]
    public class InstanceList : HybridCollection<IActivityReference>
    {
        ...
        //    Justification = "Needs to be public for serialization in partial trust. We have set InternalsVisibleTo(System.Runtime.Serialization) to allow this.")]
        public void OnSerializing(StreamingContext context) => Compress();
