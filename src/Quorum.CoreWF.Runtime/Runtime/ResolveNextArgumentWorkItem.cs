...
public class ResolveNextArgumentWorkItem : ActivityExecutionWorkItem
{
    ...
    public int SerializedNextArgumentIndex
    {
    ...
    public IDictionary<string, object> SerializedArgumentValueOverrides
    {
    ...
    public Location SerializedResultLocation
    {
        get => _resultLocation;
    ...
    public bool CanExecuteUserCode()
    {
