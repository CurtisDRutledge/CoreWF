...
public class ValidationError
{
    ...
    public ValidationError(string message, Activity activity)
        : this(message, false, string.Empty, activity) { }

    public ValidationError(string message, bool isWarning, Activity activity)
        : this(message, isWarning, string.Empty, activity) { }

    public ValidationError(string message, bool isWarning, string propertyName, Activity activity)
    {
        Message = message;
        IsWarning = isWarning;
