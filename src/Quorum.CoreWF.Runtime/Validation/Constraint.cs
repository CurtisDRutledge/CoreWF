...
public abstract class Constraint : NativeActivity
{
    ...
    public const string ToValidateArgumentName = "ToValidate";
    public const string ValidationErrorListArgumentName = "ViolationList";
    public const string ToValidateContextArgumentName = "ToValidateContext";
