...
public sealed class ValidationContext
{
    ...
    public ValidationContext(ActivityUtilities.ChildActivity owner, ActivityUtilities.ActivityCallStack parentChain, ProcessActivityTreeOptions options, LocationReferenceEnvironment environment)
    {
        _owner = owner;
    ...
    public IEnumerable<Activity> GetParents()
    {
    ...
    public IEnumerable<Activity> GetWorkflowTree()
    {
    ...
    public IEnumerable<Activity> GetChildren()
    {
    ...
    public void AddGetChildrenErrors(ref IList<ValidationError> validationErrors)
    {
