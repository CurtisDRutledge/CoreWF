...
public abstract class Variable : LocationReference
{
    ...
    public abstract ActivityWithResult DefaultCore { get; set; }

    public bool IsPublic { get; set; }

    public object Origin { get; set; }

    public Activity Owner { get; private set; }

    public bool IsInTree => Owner != null;
    ...
    public bool InitializeRelationship(Activity parent, bool isPublic, ref IList<ValidationError> validationErrors)
    {
    ...
    public abstract Location DeclareLocation(ActivityExecutor executor, ActivityInstance instance);

    // This method exists for debugger use
    public Location InternalGetLocation(LocationEnvironment environment)
    {
    ...
    public abstract void PopulateDefault(ActivityExecutor executor, ActivityInstance parentInstance, Location location);

    public abstract void SetIsWaitingOnDefaultValue(Location location);
...
public sealed class Variable<T> : Variable
{
    ...
    public override ActivityWithResult DefaultCore
    {
        get => Default;
        set
        {
    ...
    public override Location DeclareLocation(ActivityExecutor executor, ActivityInstance instance)
    {
    ...
    public override void PopulateDefault(ActivityExecutor executor, ActivityInstance parentInstance, Location location)
    {
    ...
    public override void SetIsWaitingOnDefaultValue(Location location)
    {
    ...
    public sealed class VariableLocation : Location<T>, INotifyPropertyChanged
    {
        ...
        public VariableModifiers SerializedModifiers
        {
            get => modifiers;
            set => modifiers = value;
        }
        ...
        public bool SerializedIsHandle
        {
            get => isHandle;
            set => isHandle = value;
        }
        ...
        public bool SerializedIsWaitingOnDefaultValue
        {
            get => isWaitingOnDefaultValue;
            set => isWaitingOnDefaultValue = value;
        }

        public override bool CanBeMapped => VariableModifiersHelper.IsMappable(modifiers);
        ...
        public void SetInitialValue(T value) => base.Value = value;

        public void SetIsWaitingOnDefaultValue()
        {
            if (VariableModifiersHelper.IsReadOnly(modifiers))
            {
