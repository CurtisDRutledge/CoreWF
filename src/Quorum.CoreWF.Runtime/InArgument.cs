...
public sealed class InArgument<T> : InArgument
{
    ...
    public override bool TryPopulateValue(LocationEnvironment targetEnvironment, ActivityInstance activityInstance, ActivityExecutor executor)
    {
    ...
    public override void Declare(LocationEnvironment targetEnvironment, ActivityInstance targetActivityInstance)
