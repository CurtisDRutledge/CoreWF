...
public sealed class ActivityInfo
{
    ...
    public ActivityInfo(ActivityInstance instance)
        : this(instance.Activity, instance.Activity.InternalId)
    {
        Instance = instance;
    }

    public ActivityInfo(Activity activity, long instanceId)
    {
        Activity = activity;
        _instanceIdInternal = instanceId;
    }

    public ActivityInstance Instance { get; private set; }
