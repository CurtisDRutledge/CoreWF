...
public sealed class ActivityStateRecord : TrackingRecord
{
    ...
    public ActivityStateRecord(Guid instanceId, ActivityInstance instance, ActivityInstanceState state)
        : this(instanceId, new ActivityInfo(instance), state) { }

    public ActivityStateRecord(Guid instanceId, ActivityInfo activity, ActivityInstanceState state)
        : base(instanceId)
    {
        Activity = activity;
    ...
    IDictionary<string, object> SerializedVariables
    {
        get => _variables;
    ...
    IDictionary<string, object> SerializedArguments
    {
        get => _arguments;
    ...
    ActivityInfo SerializedActivity
    {
        get => Activity;
        set => Activity = value;
    }
    ...
    public override TrackingRecord Clone() => new ActivityStateRecord(this);
    ...
    public IDictionary<string, object> GetVariables(ICollection<string> variables)
    {
    ...
    public IDictionary<string, object> GetArguments(ICollection<string> arguments)
    {
