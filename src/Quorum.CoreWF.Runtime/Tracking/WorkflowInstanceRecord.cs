...
public class WorkflowInstanceRecord : TrackingRecord
{
    ...
    public WorkflowIdentity SerializedWorkflowDefinitionIdentity
    {
    ...
    public string SerializedActivityDefinitionId
    {
        get => ActivityDefinitionId;
        set => ActivityDefinitionId = value;
    }

    public override TrackingRecord Clone() => new WorkflowInstanceRecord(this);
