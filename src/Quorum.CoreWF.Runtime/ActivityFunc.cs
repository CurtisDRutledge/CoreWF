...
public sealed class ActivityFunc<TResult> : ActivityDelegate
{
    ...
    public override DelegateOutArgument GetResultArgument()
    {
        return Result;
    }

    public override IList<RuntimeDelegateArgument> InternalGetRuntimeDelegateArguments()
    {
...
public sealed class ActivityFunc<T, TResult> : ActivityDelegate
{
    ...
    public override DelegateOutArgument GetResultArgument() => Result;
