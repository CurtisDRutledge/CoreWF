...
class CompiledLocation<T> : Location<T>
{
    ...
    IList<Location> SerializedLocations
    {
        get => _locations;
    ...
    ActivityInstance SerializedRootInstance
    {
        get => _rootInstance;
    ...
    string SerializedExpressionText
    {
        get => _expressionText;
    ...
    bool SerializedForImplementation
    {
