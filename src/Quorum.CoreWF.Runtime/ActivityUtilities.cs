...
public static class ActivityUtilities
{
    ...
    public static PropertyChangedEventArgs ValuePropertyChangedEventArgs
    {
        get
        {
    ...
    public static void ValidateOrigin(object origin, Activity activity)
    {
        if (origin != null &&
    ...
    public static void ProcessActivityTreeCore(ChildActivity currentActivity, ActivityCallStack parentChain, ProcessActivityTreeOptions options, ProcessActivityCallback callback, ref IList<ValidationError> validationErrors)
    {
    ...
    private class Pop : Activity
    {
        ...
        public override void OnInternalCacheMetadata(bool createEmptyBindings)
            => throw Fx.AssertAndThrow("should never get here");
    }
