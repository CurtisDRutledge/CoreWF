...
public abstract class Argument
{
    ...
    public abstract ActivityWithResult ExpressionCore { get; set; }

    public RuntimeArgument RuntimeArgument
    {
        get => _runtimeArgument;
        set => _runtimeArgument = value;
    }

    public bool IsInTree => _runtimeArgument != null && _runtimeArgument.IsInTree;

    public bool WasDesignTimeNull { get; set; }
    ...
    public static void Bind(Argument binding, RuntimeArgument argument)
    {
        if (binding != null)
        {
    ...
    public static void TryBind(Argument binding, RuntimeArgument argument, Activity violationOwner)
    {
        if (argument == null)
        {
    ...
    public abstract Location CreateDefaultLocation();

    public abstract void Declare(LocationEnvironment targetEnvironment, ActivityInstance activityInstance);
    ...
    public void Validate(Activity owner, ref IList<ValidationError> validationErrors)
    {
        if (Expression != null)
        {
    ...
    public abstract bool TryPopulateValue(LocationEnvironment targetEnvironment, ActivityInstance targetActivityInstance, ActivityExecutor executor);
    ...
    public static Location<T> CreateLocation<T>()
    {
