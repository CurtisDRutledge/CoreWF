...
public class NativeActivityContext : ActivityContext
{
    ...
    public NativeActivityContext() { }

    // This is only used by base classes which do not take
    // part in pooling.
    public NativeActivityContext(ActivityInstance instance, ActivityExecutor executor, BookmarkManager bookmarkManager)
    ...
    public bool HasRuntimeTransaction => _executor.HasRuntimeTransaction;

    public bool RequiresTransactionContextWaiterExists => _executor.RequiresTransactionContextWaiterExists;

    public bool IsInNoPersistScope => (Properties.Find(NoPersistProperty.Name) != null) || _executor.HasRuntimeTransaction;
    ...
    public void Terminate(Exception reason) => _executor.ScheduleTerminate(reason);
    ...
    public BookmarkScope CreateBookmarkScope() => CreateBookmarkScope(Guid.Empty);

    public BookmarkScope CreateBookmarkScope(Guid scopeId) => CreateBookmarkScope(scopeId, null);

    public BookmarkScope CreateBookmarkScope(Guid scopeId, BookmarkScopeHandle scopeHandle)
    {
    ...
    public void UnregisterBookmarkScope(BookmarkScope scope)
    {
        Fx.Assert(!IsDisposed, "This should not be disposed.");
    ...
    public void InitializeBookmarkScope(BookmarkScope scope, Guid id)
    {
    ...
    public void RethrowException(FaultContext context)
    {
    ...
    public ActivityInstance ScheduleSecondaryRoot(Activity activity, LocationEnvironment environment)
    {
        Fx.Assert(!IsDisposed, "Shouldn't call this on a disposed object.");
    ...
    public void EnterNoPersist(NoPersistHandle handle)
    {
        ThrowIfDisposed();
    ...
    public void ExitNoPersist(NoPersistHandle handle)
    {
        ThrowIfDisposed();
    ...
    public void RequestTransactionContext(bool isRequires, RuntimeTransactionHandle handle, Action<NativeActivityTransactionContext, object> callback, object state)
        => _executor.RequestTransactionContext(CurrentInstance, isRequires, handle, callback, state);

    public void CompleteTransaction(RuntimeTransactionHandle handle, BookmarkCallback callback)
    {
        if (callback != null)
        {
            ThrowIfCanInduceIdleNotSet();
    ...
    public void RequestPersist(BookmarkCallback onPersistComplete)
    {
