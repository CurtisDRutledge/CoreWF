...
class CharacterSpottingTextReader : TextReader
{
    ...
    public DocumentLocation FindCharacterStrictlyAfter(char c, DocumentLocation afterLocation)
    {
    ...
    public DocumentLocation FindCharacterStrictlyBefore(char c, DocumentLocation documentLocation)
    {
        var locationList = GetLocationList(c);
        UnitTestUtility.Assert(locationList != null, "We should always find character for special characters only");
