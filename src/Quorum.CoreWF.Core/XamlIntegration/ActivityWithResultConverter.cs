...
public sealed class ActivityWithResultConverter : TypeConverterBase
{
    ...
    public static object GetRootTemplatedActivity(IServiceProvider serviceProvider)
    {
    ...
    public sealed class ExpressionConverterHelper<T> : TypeConverterHelper<Activity<T>>
    {
