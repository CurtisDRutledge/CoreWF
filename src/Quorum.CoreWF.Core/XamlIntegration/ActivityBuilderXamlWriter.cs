...
class ActivityBuilderXamlWriter : XamlWriter
{
    ...
    private abstract class BuilderXamlNode
    {
        ...
        public ActivityBuilderXamlWriter Writer { get; }
    ...
    private class ImplementationNode : BuilderXamlNode
    {
        ...
        public void AddPropertyReference(ActivityPropertyReference propertyReference)
        {
        ...
        public void SetUntransformedPropertyReferences(XamlMember propertyReferencesMember,
