...
public class TextExpressionCompiler
{
    ...
    private class CompiledExpressionDescriptor
    {
        ...
        public bool IsReference => !string.IsNullOrWhiteSpace(SetMethodName);

        public bool IsStatement => !string.IsNullOrWhiteSpace(StatementMethodName);
        ...
        public string StatementMethodName { get; set; }

        public int Id { get; set; }

        public string ExpressionText { get; set; }

        public string GetExpressionTreeMethodName { get; set; }
    }
