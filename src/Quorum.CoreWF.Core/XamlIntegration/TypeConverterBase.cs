...
public abstract class TypeConverterBase : TypeConverter
{
    ...
    // and we want to avoid the demand for ReflectionPermission(MemberAccess).
    ...
    public TypeConverterBase(Type baseType, Type helperType)
    {
        _baseType = baseType;
        _helperType = helperType;
    }

    public TypeConverterBase(Type targetType, Type baseType, Type helperType)
    {
    ...
    public abstract class TypeConverterHelper<T> : TypeConverterHelper
    {
