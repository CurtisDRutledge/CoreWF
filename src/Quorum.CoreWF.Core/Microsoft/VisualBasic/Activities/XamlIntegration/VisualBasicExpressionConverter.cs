...
static class VisualBasicExpressionConverter
{
    ...
    private struct ReadOnlyXmlnsMapping
    {
        ...
        public ReadOnlyXmlnsMapping(XmlnsMapping mapping)
        {
            _wrappedMapping = mapping;
        }

        public bool IsEmpty => _wrappedMapping.IsEmpty;

        public IEnumerable<ReadOnlyVisualBasicImportReference> ImportReferences
        {
            get
            {
    ...
    private readonly struct ReadOnlyVisualBasicImportReference
    {
        ...
        public ReadOnlyVisualBasicImportReference(VisualBasicImportReference referenceToWrap)
        {
            _wrappedReference = referenceToWrap;
        }

        public string Assembly => _wrappedReference.Assembly;

        public string Import => _wrappedReference.Import;

        public Assembly EarlyBoundAssembly => _wrappedReference.EarlyBoundAssembly;

        public VisualBasicImportReference Clone()
        {
            return _wrappedReference.Clone();
        }

        // this code is borrowed from XamlSchemaContext
        public bool AssemblySatisfiesReference(AssemblyName assemblyName)
        {
